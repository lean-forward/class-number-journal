...
we can partition the set of remainders $A' = \{x \operatorname{mod} b \mid x \in A\}$ into at most $card(\epsilon)$ parts, such that for all remainders $x, y$ in the same part we have that
