...
A brief description of class groups for general domains, instead of only considering these for Dedekind domains; see the end of Section~\ref{sec math background} and Section~\ref{subsec:class_group}.
