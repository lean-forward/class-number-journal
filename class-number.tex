...
In fact, for a Noetherian integral domain, each nonzero ideal is a product of prime ideals if and only if all ideals are invertible; the uniqueness follows separately (see \cite[Proposition 3.8]{Neukirch} and \cite[Proposition 12.2.8]{Ireland-Rosen} for either implication).
We have formalized one direction of this equivalence, the unique ideal factorization property of a Dedekind domain \lean{D}, by instantiating a unique factorization monoid structure on its ideals:
